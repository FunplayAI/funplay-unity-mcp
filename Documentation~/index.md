...
6. For Claude Code, Cursor, and Codex, use **Configure + Skills** or open **Funplay > Project Skills** to install the built-in `unity-mcp-workflow` and `unity-ui-composition` skills
